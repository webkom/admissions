...
const ApplicationDetails: React.FC<ApplicationDetailsProps> = ({
  ...
  const isFullApplication = isFullAdminApplication(application);
  return (
    <DetailsContent>
      {isFullApplication && application.priority_text && (
        <DetailSection>
      ...
      {application.group_applications.map((groupApplication) => {
        ...
        const groupFields = (admissionGroup?.header_fields ?? []).filter(
          (field): field is InputFieldModel => "id" in field,
        );
