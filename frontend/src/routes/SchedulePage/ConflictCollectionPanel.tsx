    ...
    <div className="flex flex-col gap-3" data-cy="conflict-collection">
      <SchedulePanel>
        <SchedulePanelHeader
          ...
          description={
            stale
              ? "Kandidat- eller intervjuerlisten er endret. Start kontrollen på nytt."
              : open
                ? "Kandidatnavn er midlertidig synlige. Alle deltakende intervjuere kontrollerer hele listen før du fortsetter."
                : "Start kontrollen når planutkastet er klart. Kandidatnavn vises midlertidig mens intervjuere registrerer inhabilitet."
          }
        />
