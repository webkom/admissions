...
export const osloTodayIsoDate = (): string =>
  DateTime.now().setZone(CALENDAR_TIME_ZONE).toFormat("yyyy-MM-dd");

export const osloTodayDate = (): Date => {
  const today = DateTime.now().setZone(CALENDAR_TIME_ZONE);
